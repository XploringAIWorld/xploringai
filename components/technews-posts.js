...
import { Input, Button, Link, Card, CardHeader, CardBody, CardFooter, Divider, Spacer, } from '@nextui-org/react';



function TechNewsPostsComponent() {
    ...
    useEffect(() => {
        const unsubscribe = onSnapshot(collection(db, 'technews'), (snapshot) => {
    ...
    const handleSave = async () => {
        ...
        await updateDoc(doc(db, 'technews', editId), {
            url: editUrl,
            title: editTitle,
    ...
    const handleDelete = async (id) => {
        await deleteDoc(doc(db, 'technews', id));
    };
...
export default TechNewsPostsComponent;
